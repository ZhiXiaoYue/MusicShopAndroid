...
public class SubmitPrepareActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listenButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NewPlayActivity.actionStart(SubmitPrepareActivity.this, currentSong);
            }
        });
        recordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!(new File(Consts.SONG_DIR+currentSong.getSname() + "-" + currentSong.getSingerName() + "-" + currentSong.getAlbum() + "-" + currentSong.getSid() + ".mp3").exists())){
                    ...
                    ManyActivity.actionStart(SubmitPrepareActivity.this, currentSong);
                }
            }
        });
    }
    ...
    private void download() {
        DownloadUtil downloadUtil = new DownloadUtil(SubmitPrepareActivity.this,currentSong);
