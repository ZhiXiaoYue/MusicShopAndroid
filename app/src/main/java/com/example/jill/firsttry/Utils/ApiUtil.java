...
//    }
//
//    public AllRecordBean getAllRecord(final Activity superActivity) throws InterruptedException {
...
//                    returnMessage= returnMessage.replaceAll("\"\\[", "\\[");
//                    returnMessage= returnMessage.replaceAll("\\]\"", "\\]");
//                    arb = new Gson().fromJson(returnMessage, AllRecordBean.class);
//                    flag = true;
...
//            }
//        }
//        System.out.println(arb.getData().get(0).getRid());
//        return arb;
//    }
