...
public class DownloadPrepareActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordUrl = (String) getIntent().getSerializableExtra("url_data_from_main");
        //设置界面信息
    ...
    private void download() {
        DownloadUtil downloadUtil = new DownloadUtil(DownloadPrepareActivity.this,currentSong);
     ...
     */
    public static void actionStart(Context context, Song song, String recordU) {
        Intent intent = new Intent(context, DownloadPrepareActivity.class);
        intent.putExtra("song_data_from_main", song);
        intent.putExtra("url_data_from_main", recordU);
