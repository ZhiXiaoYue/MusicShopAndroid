package com.example.jill.firsttry.forLyrics.utils;

import com.example.jill.firsttry.forLyrics.formats.LyricsFileReader;
import com.example.jill.firsttry.forLyrics.formats.LyricsFileWriter;
import com.example.jill.firsttry.forLyrics.formats.hrc.HrcLyricsFileReader;
import com.example.jill.firsttry.forLyrics.formats.hrc.HrcLyricsFileWriter;
import com.example.jill.firsttry.forLyrics.formats.krc.KrcLyricsFileReader;
import com.example.jill.firsttry.forLyrics.formats.krc.KrcLyricsFileWriter;
import com.example.jill.firsttry.forLyrics.formats.ksc.KscLyricsFileReader;
import com.example.jill.firsttry.forLyrics.formats.ksc.KscLyricsFileWriter;
import com.example.jill.firsttry.forLyrics.formats.lrc.LrcLyricsFileReader;
import com.example.jill.firsttry.forLyrics.formats.lrc.LrcLyricsFileWriter;
